namespace WPBlogML
{
    ...
    /// <summary>
    /// Embedded BlogML XSD schemas, so that the EXE can be self-contained, without requiring external schema files.
    /// </summary>
    public static class Schemas
    {

        public static XmlSchema BlogML2_0
        {
            get
            {
                return XmlSchema.Read(new StringReader(blogML2_0), ((object sender, ValidationEventArgs e) =>
                {
                    Console.Error.WriteLine("Error creating schema\n" + e.Message);
                }));
            }
        }

        public static XmlSchema BlogML2_0_With_Tags
        {
            get
            {
                return XmlSchema.Read(new StringReader(blogML2_0_with_tags), ((object sender, ValidationEventArgs e) =>
                {
                    Console.Error.WriteLine("Error creating schema\n" + e.Message);
                }));
            }
        ...
        /// <summary>
        /// BlogML 2.0 XSD schema
        /// </summary>
        private static string blogML2_0 =
@"<?xml version=""1.0"" encoding=""utf-8""?>
<xs:schema attributeFormDefault=""unqualified""
		elementFormDefault=""qualified""
		xmlns:xs=""http://www.w3.org/2001/XMLSchema""
		targetNamespace=""http://www.blogml.com/2006/09/BlogML""
	...
	<xs:complexType name=""blogType"">
		...
		<xs:sequence>
			...
			<xs:element name=""authors""
					...
					minOccurs=""1""
					maxOccurs=""1"" />
			<xs:element name=""extended-properties""
					minOccurs=""0""
					maxOccurs=""1""
	...
	<xs:complexType name=""postType"">
		...
		<xs:complexContent mixed=""false"">
			<xs:extension base=""nodeType"">
				...
				<xs:attribute name=""post-url""
						type=""xs:string"" />
				<xs:attribute name=""type""
						type=""blogpostTypes"" />
				<xs:attribute name=""hasexcerpt""
						type=""xs:boolean"" />
				<xs:attribute name=""views""
						type=""xs:string"" />
			</xs:extension>
		</xs:complexContent>
	</xs:complexType>
	<xs:complexType name=""nodeType"">
		...
		<xs:attribute name=""date-modified""
				type=""xs:dateTime""
				use=""optional"">
			<xs:annotation>
				<xs:documentation>
	...
	<xs:complexType name=""attachmentType"">
		...
		<xs:simpleContent>
			<xs:extension base=""xs:string"">
				...
				<xs:attribute name=""external-uri""
						type=""xs:string""
						use=""optional"">
					<xs:annotation>
						<xs:documentation>
	...
	<xs:complexType name=""extendedpropertyType"">
        ...
        /// BlogML 2.0 XSD schema
        /// </summary>
        private static string blogML2_0_with_tags =
@"<?xml version=""1.0"" encoding=""utf-8""?>
<xs:schema attributeFormDefault=""unqualified""
		elementFormDefault=""qualified""
		xmlns:xs=""http://www.w3.org/2001/XMLSchema""
